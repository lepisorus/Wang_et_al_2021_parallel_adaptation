...
head(neutral.SNPtype3)
write.table(neutral.SNPtype3[, c(1,5,6,4)], file="SW_US_Andes.neutralSNP.ancestral2dsfs.txt", quote=F, sep="\t", row.names=F)


# find out the 2dsfs in outlier SNPs
MH.Andes.outlier <- read.delim("../Andes.SW_US.outlier.SNPtype")
...
write.table(t, file="SW_US.Andes.outlier.ancestral2dsfs.txt", quote=F, sep="\t", row.names=F)
